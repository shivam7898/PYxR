...
- Python [pandas](https://pypi.org/project/pandas) has [to_csv()](https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.to_csv.html) & [read_csv()](https://pandas.pydata.org/docs/reference/api/pandas.read_csv.html)
...
- Python needs `rpy2` module which is unavilable in Windows
...
- Python [pyarrow](https://pypi.org/project/pyarrow) has [write_feather()](https://arrow.apache.org/docs/python/generated/pyarrow.feather.write_feather.html) & [read_feather()](https://arrow.apache.org/docs/python/generated/pyarrow.feather.read_feather.html)
